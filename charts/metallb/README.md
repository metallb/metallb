...
| speaker.hostNetwork | bool | `true` | Whether to enable host networking for the speaker pods. In typical deployments, Layer 2 mode requires this to be true so the speaker can send and receive ARP/NDP traffic on the host network. |
