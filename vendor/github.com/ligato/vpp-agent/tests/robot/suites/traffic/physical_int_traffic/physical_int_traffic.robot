...
Setup Interfaces
    vpp_ctl: Put Physical Interface With IP    node=agent_vpp_1    name=GigabitEthernet0/9/0    ip=192.168.1.1
...
##    vpp_ctl: Put TAP Interface With IP    node=agent_vpp_1    name=vpp1_tap1    mac=32:21:21:11:11:11    ip=30.30.1.1    host_if_name=linux_vpp1_tap1
    ...
    vpp_ctl: Put Physical Interface With IP    node=agent_vpp_2    name=GigabitEthernet0/a/0    ip=192.168.1.2
