...
Check Memif1 Interface On VPP1 Connected After Second Libmemif Added
    Sleep    ${SYNC_SLEEP}vpp_term: Interface Is Created    node=agent_vpp_1    mac=62:61:61:61:61:61
    Sleep    ${SYNC_SLEEP}vat_term: Check Memif Interface State     agent_vpp_1  vpp1_memif1  mac=62:61:61:61:61:61  role=master  id=0  ipv4=${VPP1MEMIF_IP1}/24  connected=1  enabled=1  socket=${AGENT_LIBMEMIF_1_MEMIF_SOCKET_FOLDER}/memif.sock
    ${out}=      lmterm: Issue Command    agent_libmemif_1    show
