...
Check IPsec config_1 On VPP
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    IP Sec Should Contain  agent_vpp_1  sa 1  sa 2  spd 1  inbound policies  outbound policies
...
Check IPsec config_2 On VPP
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    IP Sec Should Contain  agent_vpp_1  sa 3  sa 4  spd 2  inbound policies  outbound policies
