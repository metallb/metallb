...
Delete Route VRF 1
    vpp_ctl: Delete Route    agent_vpp_2    1    ${NET1}    64
    vpp_ctl: Delete Route    agent_vpp_2    1    ${NET2}    64
    vpp_ctl: Delete Route    agent_vpp_2    0    ${NET3}    64
    vpp_ctl: Delete Route    agent_vpp_2    2    ${NET3}    64
