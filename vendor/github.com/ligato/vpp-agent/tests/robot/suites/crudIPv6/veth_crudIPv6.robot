...
Add Veth1 Interface
    ...
    vpp_ctl: Put Veth Interface With IP    node=agent_vpp_1    name=vpp1_veth1    mac=${VETH1_MAC}    peer=vpp1_veth2    ip=${VETHIP1}    prefix=64    mtu=1500
    linux: Interface Not Exists    node=agent_vpp_1    mac=${VETH1_MAC}
...
Add Veth3 Interface
    ...
    vpp_ctl: Put Veth Interface With IP    node=agent_vpp_1    name=vpp1_veth3    mac=${VETH3_MAC}    peer=vpp1_veth4    ip=${VETHIP2}   prefix=64    mtu=1500
    linux: Interface Not Exists    node=agent_vpp_1    mac=${VETH3_MAC}
...
Update Veth1 Interface
    vpp_ctl: Put Veth Interface With IP    node=agent_vpp_1    name=vpp1_veth1    mac=${VETH1_SEC_MAC}    peer=vpp1_veth2    ip=${VETHIP3}    prefix=64    mtu=1600
