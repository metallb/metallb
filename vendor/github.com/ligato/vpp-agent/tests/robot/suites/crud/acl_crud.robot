...
Check ACL1 is created
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL1_NAME}    ${REPLY_DATA_FOLDER}/reply_acl1_tcp.txt    ${REPLY_DATA_FOLDER}/reply_acl1_tcp_term.txt
...
Check ACL2 is created and ACL1 still Configured
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL2_NAME}   ${REPLY_DATA_FOLDER}/reply_acl2_tcp.txt    ${REPLY_DATA_FOLDER}/reply_acl2_tcp_term.txt
...
Check ACL1 Is Changed and ACL2 not changed
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL1_NAME}    ${REPLY_DATA_FOLDER}/reply_acl1_update_tcp.txt    ${REPLY_DATA_FOLDER}/reply_acl1_update_tcp_term.txt

Delete ACL2
    vpp_ctl: Delete ACL     agent_vpp_1    ${ACL2_NAME}

Check ACL2 Is Deleted and ACL1 Is Not Changed
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL2_NAME}    ${REPLY_DATA_FOLDER}/reply_acl_empty.txt    ${REPLY_DATA_FOLDER}/reply_acl2_delete_tcp_term.txt
...
Check ACL3 Is Created
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL3_NAME}    ${REPLY_DATA_FOLDER}/reply_acl3_udp.txt    ${REPLY_DATA_FOLDER}/reply_acl3_udp_term.txt
...
Check ACL4 Is Created And ACL3 Still Configured
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL4_NAME}    ${REPLY_DATA_FOLDER}/reply_acl4_udp.txt     ${REPLY_DATA_FOLDER}/reply_acl4_udp_term.txt

Delete ACL4
    vpp_ctl: Delete ACL     agent_vpp_1    ${ACL4_NAME}

Check ACL4 Is Deleted and ACL3 Is Not Changed
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL4_NAME}   ${REPLY_DATA_FOLDER}/reply_acl_empty.txt     ${REPLY_DATA_FOLDER}/reply_acl3_udp_term.txt
...
Check ACL5 Is Created
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL5_NAME}   ${REPLY_DATA_FOLDER}/reply_acl5_icmp.txt    ${REPLY_DATA_FOLDER}/reply_acl5_icmp_term.txt
...
Check ACL6 Is Created And ACL5 Still Configured
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL6_NAME}    ${REPLY_DATA_FOLDER}/reply_acl6_icmp.txt    ${REPLY_DATA_FOLDER}/reply_acl6_icmp_term.txt

Delete ACL6
    vpp_ctl: Delete ACL     agent_vpp_1    ${ACL6_NAME}

Check ACL6 Is Deleted and ACL5 Is Not Changed
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_ctl: Check ACL Reply    agent_vpp_1    ${ACL6_NAME}     ${REPLY_DATA_FOLDER}/reply_acl_empty.txt    ${REPLY_DATA_FOLDER}/reply_acl5_icmp_term.txt
