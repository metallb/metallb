...
Check Local SID CRUD
    Put Local SID                node=agent_vpp_1    localsidName=A    sidAddress=A::    fibtable=0    outinterface=vpp1_afpacket1    nexthop=A::1
    ...
    Put Local SID                node=agent_vpp_1    localsidName=A    sidAddress=A::    fibtable=0    outinterface=vpp1_afpacket1    nexthop=C::1   #modification
...
Check Policy and Policy Segment CRUD
    Put SRv6 Policy                    node=agent_vpp_1    name=AtoE            bsid=A::E          fibtable=0         srhEncapsulation=true      sprayBehaviour=true

    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_term: Check SRv6 Policy Nonexistence    node=agent_vpp_1    bsid=A::E
    Put SRv6 Policy Segment            node=agent_vpp_1    name=firstSegment    policyName=AtoE    policyBSID=A::E    weight=1                   segmentlist=${segmentList1}
    ...
    Delete SRv6 Policy Segment         node=agent_vpp_1    name=firstSegment    policyName=AtoE
    ...
    Put SRv6 Policy Segment            node=agent_vpp_1    name=secondSegment   policyName=AtoE    policyBSID=A::E    weight=2                   segmentlist=${segmentList2}
    ...
    Delete SRv6 Policy Segment         node=agent_vpp_1    name=secondSegment   policyName=AtoE
    ...
    Delete SRv6 Policy                 node=agent_vpp_1    name=AtoE
    Wait Until Keyword Succeeds   ${WAIT_TIMEOUT}   ${SYNC_SLEEP}    vpp_term: Check SRv6 Policy Nonexistence    node=agent_vpp_1    bsid=A::E

Check Steering CRUD
    Put SRv6 Policy                    node=agent_vpp_1    name=AtoE            bsid=A::E            fibtable=0         srhEncapsulation=true    sprayBehaviour=true
    Put SRv6 Policy Segment            node=agent_vpp_1    name=firstSegment    policyName=AtoE      policyBSID=A::E    weight=1                 segmentlist=${segmentList1}
    Put SRv6 Steering                  node=agent_vpp_1    name=toE             bsid=A::E            fibtable=0         prefixAddress=B::/64
    ...
    Put SRv6 Steering                  node=agent_vpp_1    name=toE             bsid=A::E            fibtable=0         prefixAddress=C::/64   # modification
    ...
    Delete SRv6 Policy                 node=agent_vpp_1    name=AtoE   #cleanup
