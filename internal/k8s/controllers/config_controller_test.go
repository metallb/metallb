...
func TestConfigController(t *testing.T) {
	...
	for _, test := range tests {
		...
		initObjects = append(initObjects, &v1beta1.ConfigurationStatus{
		...
		if gotCondition == nil {
			t.Errorf("test %s: condition %q not found in ConfigurationStatus", test.desc, conditionType)
			continue
		}
