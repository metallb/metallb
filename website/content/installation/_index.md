...
```bash
kubectl apply -f https://raw.githubusercontent.com/metallb/metallb/v0.13.1/config/manifests/metallb-native.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/metallb/metallb/v0.13.1/config/manifests/metallb-frr.yaml
```
