...
```bash
kubectl apply -f https://raw.githubusercontent.com/metallb/metallb/v0.13.8/config/manifests/metallb-frr.yaml
```
...
resources:
  - github.com/metallb/metallb/config/native?ref=v0.13.8
```
...
resources:
  - github.com/metallb/metallb/config/frr?ref=v0.13.8
```
