...
With this configuration, services labeled `tier: frontend` will be announced from
interface `eth0`, while services labeled `tier: backend` will be announced from
interface `eth1`.
