...
- MetalLB now has
  a
  [Helm chart](https://github.com/metallb/metallb/tree/v0.11.0/helm/metallb). If
...
- The
  [configuration file format](https://raw.githubusercontent.com/metallb/metallb/v0.11.0/manifests/example-config.yaml) has
