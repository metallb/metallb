...
- MetalLB now has
  a
  [Helm chart](https://github.com/google/metallb/tree/v0.5.0/helm/metallb). If
...
- The
  [configuration file format](https://raw.githubusercontent.com/google/metallb/v0.5.0/manifests/example-config.yaml) has
