...
[`manifests/example-arp-config.yaml`](https://raw.githubusercontent.com/google/metallb/v0.3.1/manifests/example-arp-config.yaml).
...
`kubectl apply -f https://raw.githubusercontent.com/google/metallb/v0.3.1/manifests/example-arp-config.yaml`
...
[`manifests/tutorial-2.yaml`](https://raw.githubusercontent.com/google/metallb/v0.3.1/manifests/tutorial-2.yaml) contains
