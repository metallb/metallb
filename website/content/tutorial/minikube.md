...
[`manifests/tutorial-1.yaml`](https://raw.githubusercontent.com/google/metallb/v0.3.1/manifests/tutorial-1.yaml). Let's take a look at it before applying
it:
...
[`manifests/tutorial-2.yaml`](https://raw.githubusercontent.com/google/metallb/v0.3.1/manifests/tutorial-2.yaml) contains a trivial service: an nginx pod,
...
[`manifests/tutorial-3.yaml`](https://raw.githubusercontent.com/google/metallb/v0.3.1/manifests/tutorial-3.yaml):
