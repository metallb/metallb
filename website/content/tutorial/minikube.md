...
`kubectl apply -f https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/test-bgp-router.yaml`
...
[`manifests/tutorial-1.yaml`](https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/tutorial-1.yaml). Let's take a look at it before applying
it:
...
`kubectl apply -f https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/tutorial-1.yaml`
...
[`manifests/tutorial-2.yaml`](https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/tutorial-2.yaml) contains a trivial service: an nginx pod,
...
[`manifests/tutorial-3.yaml`](https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/tutorial-3.yaml):
...
`kubectl apply -f https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/tutorial-3.yaml`
...
`kubectl apply -f https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/tutorial-4.yaml`
...
`kubectl delete -f https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/tutorial-2.yaml,https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/test-bgp-router.yaml,https://raw.githubusercontent.com/google/metallb/v0.4.0/manifests/metallb.yaml`
