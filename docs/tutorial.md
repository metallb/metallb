...
`10.0.0.100`, `10.0.0.101`, `10.0.0.102`, which are the addresses of
the `test-bgp-router-bird`, `test-bgp-router-quagga` and
...
I1127 08:53:49.118715       1 main.go:255] Peer "10.0.0.102" configured, starting BGP session
...
I1127 08:53:49.171023       1 bgp.go:55] BGP session to "10.0.0.102:179" established
```
