...
//+kubebuilder:webhook:verbs=create;update,path=/validate-metallb-io-v1beta1-bgppeer,mutating=false,failurePolicy=fail,groups=metallb.io,resources=bgppeers,versions=v1beta1,name=bgppeervalidationwebhook.v1beta1.metallb.io,sideEffects=None,admissionReviewVersions=v1
