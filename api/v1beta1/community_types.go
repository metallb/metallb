...
// +kubebuilder:printcolumn:name="Alias",type="string",JSONPath=".spec.alias",description="The alias for the community"
// +kubebuilder:printcolumn:name="Value",type="string",JSONPath=".spec.value",description="The value for the community"
