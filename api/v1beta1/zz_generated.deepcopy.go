...
func (in *L2AdvertisementSpec) DeepCopyInto(out *L2AdvertisementSpec) {
	*out = *in
	...
	if in.PreferredNodeSelectors != nil {
		in, out := &in.PreferredNodeSelectors, &out.PreferredNodeSelectors
		*out = make([]PreferredNodeSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreferredNodeSelector) DeepCopyInto(out *PreferredNodeSelector) {
	*out = *in
	in.Preference.DeepCopyInto(&out.Preference)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreferredNodeSelector.
func (in *PreferredNodeSelector) DeepCopy() *PreferredNodeSelector {
	if in == nil {
		return nil
	}
	out := new(PreferredNodeSelector)
	in.DeepCopyInto(out)
	return out
}
