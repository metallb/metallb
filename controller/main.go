...
func main() {
	var (
		...
		tlsMinVersion       = flag.String("tls-min-version", "", "Minimum TLS version supported. Default is TLS 1.3.")
		tlsCipherSuites     = flag.String("tls-cipher-suites", "", "Comma-separated list of cipher suites (only valid with TLS 1.2 min version)")
		tlsCurvePreferences = flag.String("tls-curve-preferences", "", "Comma-separated list of TLS curve preferences (e.g. X25519MLKEM768,x25519,secp256r1)")
	...
	tlsOpt, err := tlsconfig.TLSOptFor(*tlsCipherSuites, *tlsCurvePreferences, *tlsMinVersion)
	if err != nil {
