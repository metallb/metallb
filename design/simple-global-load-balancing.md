...
-->
# MLB-0002: Simple Global Load Balancing support
...
A possible best practice to mitigate the risk of failure of these checks is to dedicate an IPaddress pool just ofr the globally load balanced services. This way the pool usage (taken IPs vs free IPs) will be the same across the clusters.
