...
func tlsConfigFor(certFile, keyFile string, logger log.Logger) (*tls.Config, error) {
...
func tlsConfigWithCertWatcher(cfg *tls.Config, certFile, keyFile string, logger log.Logger) (*tls.Config, error) {
